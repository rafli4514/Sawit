...
export const mockSymptoms: Symptom[] = [
  ...
  { id: 1, code: "G01", label: "Daun Menjadi Layu / Terkulai", category: "Daun", severityHint: "medium", active: true, description: "Daun atau anak daun tampak layu dan terkulai.", imageUrl: "/gejala/G01.png" },
  { id: 2, code: "G02", label: "Daun Mengalami Klorosis (Menguning)", category: "Daun", severityHint: "medium", active: true, description: "Daun berubah warna menjadi hijau pucat atau kuning merata.", imageUrl: "/gejala/G02.png" },
  { id: 3, code: "G03", label: "Bercak Lonjong Kuning pada Daun", category: "Daun", severityHint: "low", active: true, description: "Timbul bercak-bercak lonjong berwarna kuning pada helaian daun.", imageUrl: "/gejala/G03.png" },
  { id: 4, code: "G04", label: "Ujung Daun Muda Cokelat Nekrosis", category: "Daun", severityHint: "medium", active: true, description: "Daun muda berubah warna menjadi cokelat gelap di ujungnya.", imageUrl: "/gejala/G04.png" },
  { id: 5, code: "G05", label: "Pelepah Sengkleh & Menggantung", category: "Batang", severityHint: "high", active: true, description: "Pelepah patah di pangkal dan menggantung pada batang.", imageUrl: "/gejala/G05.png" },
  { id: 6, code: "G06", label: "Pelepah Bengkok Menunduk ke Bawah", category: "Batang", severityHint: "medium", active: true, description: "Pelepah melengkung/menunduk ke arah bawah di bagian tengah.", imageUrl: "/gejala/G06.png" },
  { id: 7, code: "G07", label: "Pelepah Cokelat Kemerahan", category: "Batang", severityHint: "medium", active: true, description: "Pelepah mengalami diskolorasi menjadi cokelat kemerahan.", imageUrl: "/gejala/G07.png" },
  { id: 8, code: "G08", label: "Daun Tombak Melengkung / Tidak Membuka", category: "Pucuk", severityHint: "high", active: true, description: "Daun muda tombak tidak membuka secara total atau melengkung.", imageUrl: "/gejala/G08.png" },
  { id: 9, code: "G09", label: "Bercak Kuning Bagian Tengah Cokelat", category: "Daun", severityHint: "medium", active: true, description: "Bercak nekrotik kuning dengan bagian tengah berwarna cokelat.", imageUrl: "/gejala/G09.png" },
  { id: 10, code: "G10", label: "Daun Tajuk Kerdil & Kaku", category: "Daun", severityHint: "medium", active: true, description: "Daun berukuran kecil atau tajuk tumbuh mengecil dan kerdil.", imageUrl: "/gejala/G10.png" },
  { id: 11, code: "G11", label: "Daun Sobek / Tidak Berkembang", category: "Daun", severityHint: "medium", active: true, description: "Helai daun sobek-sobek atau tidak tumbuh normal pada pelepah.", imageUrl: "/gejala/G11.png" },
  { id: 12, code: "G12", label: "Daun Mengering Kecokelatan", category: "Daun", severityHint: "high", active: true, description: "Daun mengalami dehidrasi berat dan tampak mengering kecokelatan.", imageUrl: "/gejala/G12.png" },
  { id: 13, code: "G13", label: "Daun / Pelepah Rontok Prematur", category: "Batang", severityHint: "medium", active: true, description: "Daun atau pelepah gugur/rontok sebelum waktunya.", imageUrl: "/gejala/G13.png" },
  { id: 14, code: "G14", label: "Bercak Hitam/Cokelat Daun Bibit", category: "Daun", severityHint: "medium", active: true, description: "Timbul bercak-bercak hitam atau cokelat pada daun bibit nursery.", imageUrl: "/gejala/G14.png" },

  // Bagian Kuncup, Batang & Akar (G15 - G22)
  { id: 15, code: "G15", label: "Kuncup Membusuk & Berbau Busuk", category: "Pucuk", severityHint: "high", active: true, description: "Kuncup/titik tumbuh membusuk basah dan mengeluarkan aroma busuk menyengat.", imageUrl: "/gejala/G15.png" },
  { id: 16, code: "G16", label: "Akar Lunak dan Korteks Busuk", category: "Akar", severityHint: "high", active: true, description: "Sistem perakaran menjadi lunak, basah, dan korteks hancur membusuk.", imageUrl: "/gejala/G16.png" },
  { id: 17, code: "G17", label: "Badan Buah Jamur di Pangkal Batang", category: "Batang", severityHint: "high", active: true, description: "Tumbuh badan buah jamur kipas (basidiokarp) pada pangkal batang/akar.", imageUrl: "/gejala/G17.png" },
  { id: 18, code: "G18", label: "Batang Atas Membusuk & Patah", category: "Batang", severityHint: "high", active: true, description: "Batang bagian atas (1-2 m di atas tanah) membusuk dan patah (upper stem).", imageUrl: "/gejala/G18.png" },
  { id: 19, code: "G19", label: "Batang Berongga & Serbuk Kayu", category: "Batang", severityHint: "high", active: true, description: "Batang bagian dalam berongga dan ada tumpukan serbuk kayu halus.", imageUrl: "/gejala/G19.png" },
  { id: 20, code: "G20", label: "Lubang Gerekan Kecil pada Batang", category: "Batang", severityHint: "medium", active: true, description: "Terdapat lubang-lubang gerekan kecil pada batang akibat rayap.", imageUrl: "/gejala/G20.png" },
  { id: 21, code: "G21", label: "Sarang Rayap di Sekitar Akar/Pangkal", category: "Akar", severityHint: "high", active: true, description: "Ditemukan lorong tanah atau sarang rayap di sekitar perakaran/pangkal.", imageUrl: "/gejala/G21.png" },
  { id: 22, code: "G22", label: "Tanaman Roboh / Tumbang / Mati", category: "Batang", severityHint: "high", active: true, description: "Tanaman roboh, tumbang, atau mati mendadak.", imageUrl: "/gejala/G22.png" },

  // Bagian Bunga, Buah & Produksi (G23 - G28)
  { id: 23, code: "G23", label: "Rizomorf Jamur Putih pada Buah", category: "Buah", severityHint: "high", active: true, description: "Miselium jamur berwarna putih menyelimuti permukaan tandan buah.", imageUrl: "/gejala/G23.png" },
  { id: 24, code: "G24", label: "Pangkal Buah & Tandan Busuk Berbau", category: "Buah", severityHint: "high", active: true, description: "Pangkal buah busuk basah dan tandan rusak mengeluarkan bau busuk.", imageUrl: "/gejala/G24.png" },
  { id: 25, code: "G25", label: "Buah Keriput, Kering & Kerdil", category: "Buah", severityHint: "medium", active: true, description: "Buah mengering, keriput, dan gagal berkembang sempurna.", imageUrl: "/gejala/G25.png" },
  { id: 26, code: "G26", label: "Buah Kehitaman & Biji Rontok", category: "Buah", severityHint: "medium", active: true, description: "Warna buah berubah kehitaman dan biji/brondolan mudah rontok.", imageUrl: "/gejala/G26.png" },
  { id: 27, code: "G27", label: "Bunga Tombak Tidak Membuka", category: "Buah", severityHint: "medium", active: true, description: "Tandan bunga tidak membuka atau pembentukan bunga terhambat.", imageUrl: "/gejala/G27.png" },
  { id: 28, code: "G28", label: "Penurunan Drastis Produksi TBS", category: "Buah", severityHint: "high", active: true, description: "Produksi tandan buah segar menurun drastis mencapai 40% - 60%.", imageUrl: "/gejala/G28.png" },

  // Gejala Khusus 4 Hama (G29 - G38)
  { id: 29, code: "G29", label: "Kerusakan Bibit Digigit Pengerat", category: "Batang", severityHint: "high", active: true, description: "Bibit kelapa sawit rusak digigit atau terpotong oleh hama tikus.", imageUrl: "/gejala/G29.png" },
  { id: 30, code: "G30", label: "Bekas Keratan Gigi pada Pelepah", category: "Batang", severityHint: "medium", active: true, description: "Bekas gigitan dan pengeratan gigi pada pangkal pelepah sawit.", imageUrl: "/gejala/G30.png" },
  { id: 31, code: "G31", label: "Bekas Gigitan Buah & Inti Sawit", category: "Buah", severityHint: "high", active: true, description: "Bekas gigitan pada buah mentah/masak hingga merusak inti sawit.", imageUrl: "/gejala/G31.png" },
  { id: 32, code: "G32", label: "Bibit Mati Akibat Pengeratan Titik Tumbuh", category: "Batang", severityHint: "high", active: true, description: "Tanaman sawit muda mati karena titik tumbuh pangkal bibit dikerat tikus.", imageUrl: "/gejala/G32.png" },
  { id: 33, code: "G33", label: "Helaian Daun Berlubang Ulat Api", category: "Daun", severityHint: "high", active: true, description: "Helaian daun berlubang-lubang dimakan ulat api secara rakus.", imageUrl: "/gejala/G33.png" },
  { id: 34, code: "G34", label: "Kehilangan Daun Bawah >80%", category: "Daun", severityHint: "high", active: true, description: "Kerusakan parah daun bagian bawah hingga >80% daun habis.", imageUrl: "/gejala/G34.png" },
  { id: 35, code: "G35", label: "Daun Terkikis Menyisakan Tulang Lidi", category: "Daun", severityHint: "high", active: true, description: "Daun terkikis habis menyisakan lidi, tajuk bawah tampak abu-abu.", imageUrl: "/gejala/G35.png" },
  { id: 36, code: "G36", label: "Daun Tajuk Bawah Kering Abu-Abu", category: "Daun", severityHint: "high", active: true, description: "Daun tajuk bagian bawah mengering kusam dan keabu-abuan.", imageUrl: "/gejala/G36.png" },
  { id: 37, code: "G37", label: "Kantong Ulat Menggantung di Daun", category: "Daun", severityHint: "high", active: true, description: "Ditemukan kantong-kantong ulat menggantung pada permukaan bawah pelepah.", imageUrl: "/gejala/G37.png" },
  { id: 38, code: "G38", label: "Daun Rusak Bergerigi Tidak Utuh", category: "Daun", severityHint: "medium", active: true, description: "Helaian daun tampak rusak tidak utuh dan bergerigi dimakan ulat kantong.", imageUrl: "/gejala/G38.png" },
];
